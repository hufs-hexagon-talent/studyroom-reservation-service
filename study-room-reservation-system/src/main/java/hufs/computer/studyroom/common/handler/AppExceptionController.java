...
import hufs.computer.studyroom.common.error.exception.checkin.*;
import hufs.computer.studyroom.common.error.exception.invalidvalue.*;
import hufs.computer.studyroom.common.error.exception.notfound.*;
import hufs.computer.studyroom.common.error.exception.reservation.*;
import hufs.computer.studyroom.common.error.exception.user.*;
import hufs.computer.studyroom.common.util.ErrorResponseDto;
import hufs.computer.studyroom.common.error.exception.AuthCodeMismatchException;
import hufs.computer.studyroom.common.error.exception.NoShowLimitExceededException;
import hufs.computer.studyroom.common.error.exception.administrative.AdministrativeException;
import hufs.computer.studyroom.common.error.exception.administrative.ScheduleAlreadyExistException;
